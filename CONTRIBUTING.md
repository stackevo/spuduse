...
documents](https://datatracker.ietf.org/wg/spud/documents/) and [mailing
list discussion](https://mailarchive.ietf.org/arch/browse/spud/). If you're
...
([info](https://www.ietf.org/mailman/listinfo/spud)). This will ensure that
